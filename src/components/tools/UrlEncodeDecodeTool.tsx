  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <div>
          <label htmlFor="url-encode-input" className="text-sm font-semibold text-slate-900">
            {messages.inputLabel}
          </label>
          <textarea
            id="url-encode-input"
        ...
        <div>
          <label htmlFor="url-encode-output" className="text-sm font-semibold text-slate-900">
